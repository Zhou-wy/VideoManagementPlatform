...
elseif (CMAKE_SYSTEM_NAME MATCHES "Windows")
    set(CMAKE_PREFIX_PATH "D:/Qt5.12.5/5.12.5/mingw73_64")
    set(FFMPEG_DIR ${PROJECT_SOURCE_DIR}/3rdparty/ffmpeg4)
    set(gLOG_DIR ${PROJECT_SOURCE_DIR}/3rdparty/gLog)

    # 设置cmake缓存文件夹
    set(CMAKE_MODULE_PATH ${CMAKE_SOURCE_DIR}/0build-windows)
...
include_directories(${gLOG_DIR}/include) # gLog头文件搜索路径

link_directories(${FFMPEG_DIR}/lib) # FFMPEG动态链接库或静态链接库的搜索路径
link_directories(${gLOG_DIR}/lib) # gLog动态链接库或静态链接库的搜索路径
