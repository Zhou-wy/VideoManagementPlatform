...
void IconHelper::initFont() {
    ...
    if (!isInit) {
        ...
        if (iconFontAliBaBa == 0) {
            iconFontAliBaBa = new IconHelper(":/qss/font/iconfont.ttf", "iconfont");
        }
        if (iconFontAwesome == 0) {
            iconFontAwesome = new IconHelper(":/qss/font/fontawesome-webfont.ttf", "FontAwesome");
        }
        if (iconFontAwesome6 == 0) {
            iconFontAwesome6 = new IconHelper(":/qss/font/fa-regular-400.ttf", "Font Awesome 6 Pro Regular");
        }
        if (iconFontWeather == 0) {
            iconFontWeather = new IconHelper(":/qss/font/pe-icon-set-weather.ttf", "pe-icon-set-weather");
        }
    }
}
